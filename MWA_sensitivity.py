...
if __name__ == "__main__":
    ...
    fig = plt.figure()
    ax = plt.gca()
    ax.scatter(freq_array, eff_rad * 100, label='Calculated Efficiency', marker='.')
    plt.xlabel('Frequency, MHz')
    plt.ylabel('Receiver\'s Radiation Efficiency, %')
    plt.grid()
    plt.legend()
    plt.show()
    ...
    fig = plt.figure()
    ax = plt.gca()
    ax.scatter(freq_array, area_realised / tau, label='area_realised/tau', marker='.')
    plt.xlabel('Frequency, MHz')
    plt.ylabel('Array Effective Area, m^2')
    plt.grid()
    plt.legend()
    plt.show()
    ...
    ax = plt.gca()
    ax.set_yscale('log')
    ax.scatter(freq_array, ant_temp / tau, label='ant_temp*eff_rad/tau', marker='.')
    plt.xlabel('Frequency, MHz')
    plt.ylabel('Temperature of the antenna due to Sky, K')
    plt.grid()
    plt.legend()
    plt.show()
    ...
    ax = plt.gca()
    ax.set_yscale('log')
    ax.scatter(freq_array, rcv_temp, label='rec_temp Calculated', marker='.')
    plt.xlabel('Frequency, MHz')
    plt.ylabel('Receiver\'s Noise Temperature, K')
    plt.grid()
    plt.legend()
    plt.show()
    ...
    fig = plt.figure()
    ax = plt.gca()
    ax.scatter(freq_array, sys_temp, label='sys_temp', marker='.')
    plt.xlabel('Frequency, MHz')
